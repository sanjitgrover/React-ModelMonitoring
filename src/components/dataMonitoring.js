...
const avatar = {
    green : <Avatar style={{ backgroundColor: "green", verticalAlign: "middle", display:"block" }} size="small">
    </Avatar>,
    orange : <Avatar style={{ backgroundColor: "orange", verticalAlign: "middle", display:"block" }} size="small">
    </Avatar>,
    red : <Avatar style={{ backgroundColor: "red", verticalAlign: "middle", display:"block" }} size="small">
    </Avatar>
};
    ...
    constructor() {
        ...
        this.state = {
            ...
            options: {
                ...
                xaxis: {
                    categories: ['Profitability', 'Repayment Capability', 'Activity', 'Growth', 'Financial Structure'],
                },
                title: {
